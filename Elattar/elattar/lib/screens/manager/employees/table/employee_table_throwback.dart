...
class EmployeeTableThrowBack extends StatefulWidget {
  const EmployeeTableThrowBack({Key? key,
    required this.moderatorId,
  }) : super(key: key);
  final String moderatorId;
  static String id = 'EmployeeTableThrowBack';

  @override
  EmployeeTableThrowBackState createState() => EmployeeTableThrowBackState();
}

class EmployeeTableThrowBackState extends State<EmployeeTableThrowBack> {
  ...
  Widget _buildDataGrid() {
    final getDataFromFireStore = FirebaseFirestore.instance.collection('Returns')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('الفواتير المرتجعه'),
      ),
      body: _buildDataGrid(),
    );
  }
