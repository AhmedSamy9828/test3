...
class EmployeeTableCheck extends StatefulWidget {
  const EmployeeTableCheck({Key? key,
    required this.moderatorId,
  }) : super(key: key);
  final String moderatorId;
  static String id = 'EmployeeTableCheck';

  @override
  EmployeeTableCheckState createState() => EmployeeTableCheckState();
}

class EmployeeTableCheckState extends State<EmployeeTableCheck> {
