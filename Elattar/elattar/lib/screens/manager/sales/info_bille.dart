...
class InfoBill extends StatefulWidget {
  const InfoBill({Key?key,
  ...
  static String id = 'InfoBill';

  @override
  State<InfoBill> createState() => _InfoBillState();
}

class _InfoBillState extends State<InfoBill> {
