...
// import 'package:el_attar_windows/screens/moderators/home_moderators.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:el_attar_windows/services/auth.dart';
...
//                             Navigator.of(context).pushNamedAndRemoveUntil(HomeManager.id, (route) => false);
//
//                             // Document manager = await Firestore.instance.collection('Manager').document(user.userId).get();
//                             // if (manager.id != null) {
//                             //   // ignore: use_build_context_synchronously
//                             //   Navigator.of(context).pop();
//                             //   // ignore: use_build_context_synchronously
